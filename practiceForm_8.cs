...
{
    public partial class practiceForm_8 : Form
    {
        public practiceForm_8()
        {
            InitializeComponent();
        }

        private void practiceForm_8_Load(object sender, EventArgs e)
        {
        ...
        private void CalculateResult()
        {
            ...
            if (trueAnswer31.Checked && trueAnswer32.Checked) totalScore++;
        }
