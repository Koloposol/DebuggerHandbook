...
{
    public partial class practiceForm_2 : Form
    {
        public practiceForm_2()
        {
            InitializeComponent();
        }

        private void practiceForm_2_Load(object sender, EventArgs e)
        {
        ...
        private void CalculateResult()
        {
            ...
            if (trueAnswer21.Checked && trueAnswer22.Checked && trueAnswer23.Checked && falseAnswer2.CheckState == CheckState.Unchecked) totalScore++;
