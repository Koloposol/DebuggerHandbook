...
{
    public partial class practiceForm_5 : Form
    {
        public practiceForm_5()
        {
            InitializeComponent();
        }

        private void practiceForm_5_Load(object sender, EventArgs e)
        {
        ...
        private void CalculateResult()
        {
            ...
            if (trueAnswer21.Checked) totalScore++;
