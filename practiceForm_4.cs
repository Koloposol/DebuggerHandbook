...
{
    public partial class practiceForm_4 : Form
    {
        public practiceForm_4()
        {
            InitializeComponent();
        }

        private void practiceForm_4_Load(object sender, EventArgs e)
        {
        ...
        private void CalculateResult()
        {
            ...
            if (trueAnswer31.Checked && trueAnswer33.Checked) totalScore++;
        }
