...
{
    public partial class practiceForm_3 : Form
    {
        public practiceForm_3()
        {
            InitializeComponent();
        }

        private void practiceForm_3_Load(object sender, EventArgs e)
        {
        ...
        private void CalculateResult()
        {
            ...
            if (trueAnswer31.Checked && trueAnswer32.Checked && trueAnswer33.Checked && trueAnswer34.Checked) totalScore++;
        }
